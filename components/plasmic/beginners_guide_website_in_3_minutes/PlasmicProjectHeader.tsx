...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: 1Q9SFfaBwMQ5/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__egoA9)}>
        <div className={classNames(projectcss.all, sty.column__dNai9)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__at6AH)}>
          <div className={classNames(projectcss.all, sty.columns__ninEw)}>
            <div className={classNames(projectcss.all, sty.column__t0Mk)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__nev1)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__oEVn)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__jKnva)}>
                {renderPlasmicSlot({
